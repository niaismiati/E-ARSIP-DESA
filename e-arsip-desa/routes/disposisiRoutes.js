...
router.post('/', verifyToken, checkRole(['admin', 'operator', 'kades']), disposisiController.create);
router.put('/:id', verifyToken, checkRole(['admin', 'operator', 'kades']), disposisiController.update);
